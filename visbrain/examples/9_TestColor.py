...
connect = np.array(sparse_matrix.todense(),dtype = 'float64')
...
cmap = 'autumn'				# Matplotlib colormap
...
vb = vbrain_func(s_xyz=newCoords, s_text=newLabels, s_textcolor="white", c_cmap_vmin=cmap_vmin, c_cmap_vmax=cmap_vmax, c_cmap=cmap,c_cmap_under=cmap_under, c_cmap_over= cmap_over,c_connect = connect)
vb.show()
